...
- Downgrade TypeScript to 5.9 to fix empty `types.d.ts` caused by api-extractor incompatibility with TS 6.0

## [1.2.1] - 2026-04-13

### Changed

- Add `/*#__PURE__*/` annotations to all top-level function calls for better tree-shaking
- Inline `Lazy<T>` interface into function return type, removing redundant export
- Upgrade devDependencies (TypeScript 6, ESLint 10, Vite 8, Vitest 4.1, etc.)
- Use HTTPS URL for tsconfig `$schema`
...
[1.2.2]: https://github.com/JiangJie/happy-codec/compare/v1.2.1...v1.2.2
[1.2.1]: https://github.com/JiangJie/happy-codec/compare/v1.2.0...v1.2.1
